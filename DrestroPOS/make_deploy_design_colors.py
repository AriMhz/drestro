...
php_script += "    echo '<h1>Design & Gradient Fix Deployed!</h1>';\n"
php_script += "    echo '<p>The dark mode gradients and Kitchen Display colors are now perfect!</p>';\n"
php_script += "} else {\n"
php_script += "    echo '<h1>Error extracting zip</h1>';\n"
php_script += "}\n"
php_script += "?>"

with open('deploy_design_colors.php', 'w') as f:
    f.write(php_script)
