...
@if(session()->has('invite_link'))
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div class="hidden lg:block">
            <!-- Title removed to prevent duplication with top navbar -->
        </div>
...
{{-- Page Access Control — super_admin can configure for any role --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-bold text-slate-700 mb-1 dark:text-slate-300">Phone Number <span class="text-red-400 font-black">*</span></label>
