...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-slate-50 font-[Inter] antialiased text-slate-800">
        <div class="h-screen flex flex-col overflow-hidden">
            ...
            <header class="h-16 bg-white/80 backdrop-blur-md border-b border-slate-200/50 flex items-center justify-between px-6 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] flex-shrink-0 z-50 sticky top-0">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-sm font-bold text-slate-500">{{ $title ?? 'Staff Panel' }}</span>
                    </div>
                </div>
                <div class="flex items-center gap-2 px-3 py-1.5 bg-emerald-50 rounded-full border border-emerald-100 shadow-inner">
