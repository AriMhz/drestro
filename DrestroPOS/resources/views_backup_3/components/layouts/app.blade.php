...
<body class="bg-slate-50 dark:bg-[#111111] dark:text-slate-100 font-[Inter] antialiased text-slate-800 transition-colors">
        <div>
            <div class="flex h-screen overflow-hidden">
                ...
                <!-- Sidebar -->
                <aside id="mobile-sidebar" class="-translate-x-full lg:translate-x-0 fixed lg:relative inset-y-0 left-0 z-50 w-64 bg-white dark:bg-[#0a0a0a] border-r border-slate-200 dark:border-slate-800 flex flex-col transition-transform duration-300 lg:transform-none">
                ...
                <nav class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 flex items-center justify-around h-16 px-1 z-50 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] pb-safe dark:bg-[#1a1a1a] dark:border-[#333]">
                    ...
                    <!-- Menu / Sidebar Toggle -->
                    <button onclick="toggleMobileSidebar()" class="flex flex-col items-center justify-center w-full h-full space-y-1 text-slate-500 hover:text-emerald-600 transition-colors">
